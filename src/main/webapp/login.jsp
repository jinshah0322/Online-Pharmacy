								...
								<div class="card-body p-md-5 mx-md-4">
									<div class="text-center">
										<img src="images/logo.png" class="image"
											style="width: 225px; height: 60px;" alt="logo">
									...
									<form action="loginlogic.jsp" method="post">
										...
										<button type="submit" class="btn"
											style="color: #fff; margin-left: 100px; width: 130px; background: #2d8b72;">Login</button>
										<a href="forget_password.jsp"><p class="mb-0 me-2 for"
												style="width: 150px; margin-top: 10px; color: #000;">Forgot
												Password?</p></a>
